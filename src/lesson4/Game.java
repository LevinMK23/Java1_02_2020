...
public class Game {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        initTable(tab);
        /*System.out.println(isValidStep(0, 0, tab));
        System.out.println(isValidStep(0, 1, tab));
        System.out.println(isValidStep(0, 2, tab));
        System.out.println(isValidStep(0, 3, tab));
        System.out.println(isValidStep(5, 5, tab));*/
